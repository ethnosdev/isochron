...
class AppTheme {
  ...
  static const Color lightDestructive = Color(0xFFAC3400);       // Terracotta (secondary)
  ...
  static const Color darkBg = Color(0xFF111C2D);                 // on-surface becomes background
  ...
  static const Color darkOnSurfaceVariant = Color(0xFFBCC9C6);   // outline-variant
  static const Color darkOutline = Color(0xFF6D7A77);
  static const Color darkOutlineVariant = Color(0xFF3D4947);
  static const Color darkAccent = Color(0xFF6BD8CB);             // inverse-primary (Mint/Teal light)
  static const Color darkDestructive = Color(0xFFFD6B36);        // secondary-container (Terracotta bright)
